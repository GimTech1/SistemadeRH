...
export default function InvoicesPage() {
  ...
  const recipients: Recipient[] = [
    { id: process.env.NEXT_PUBLIC_JOSE_ID!, name: 'José Fernando Cunha' },
    { id: process.env.NEXT_PUBLIC_BIANCA_ID!, name: 'Bianca dos Santos Leandro' }
  ]

  const joseId = process.env.NEXT_PUBLIC_JOSE_ID!
  const biancaId = process.env.NEXT_PUBLIC_BIANCA_ID!
  const newAllowedId = process.env.NEXT_PUBLIC_NEW_ALLOWED_ID!
