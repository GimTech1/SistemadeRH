                ...
                {isEditing && (
                  <div className="flex items-center gap-2 mb-3">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-platinum-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-yinmn-blue-500 focus:border-transparent"
                    />
                    <button
